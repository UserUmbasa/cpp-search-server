...
public:
    ...
    int GetDocumentId(int index) const
    {
        ...
        {
            throw out_of_range("Такой ID не существует");
        }
        else
        {
...
int main()
{
    ...
    try
    {
        ...
        search_server.AddDocument(23, "пушистый кот пушистый хвост"s, DocumentStatus::ACTUAL, { 7, 2, 7 });
